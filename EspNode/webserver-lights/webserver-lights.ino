...
void setup() {
  ...
  analogWrite(PWMPIN,(int)1023/pwmpercent);
...
void loop(){
  ...
  else if(incomingByte==53 ||incomingByte==251 || incomingByte==243){
      setRGB(200,0,200);
    }
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf("GET /5/on") >= 0) {
              ...
              blink();
            }else if (header.indexOf("GET /pwm/half") >= 0) {
            ...
            // Web Page Heading
            client.println("<body><h1>ESP8266 Web Server</h1><p>");
            client.print(Byte);
            client.print("<p>");
            ...
            client.println("<p><a href=\"/pwm/half\"><button class=\"button\">half</button></a></p>");
    ...
    Serial.println(pwmpercent);
     if(pwmpercent==0){
      analogWrite(PWMPIN,0);
        ...
        double calc=1023*(pwmpercent/100);
        Serial.print("pwm val /1024: ");
        Serial.println((int)calc);
        analogWrite(PWMPIN,(int)calc);
      }
